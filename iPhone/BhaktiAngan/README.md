...
(Internal Xcode target/folder name remains "BhaktiAngan"; only user-facing
...
Open `BhaktiAngan.xcodeproj`, select the `BhaktiAngan` scheme, and run on
...
`BhaktiAngan/Resources/Subscriptions.storekit` provides local StoreKit
...
- `BhaktiAnganTests/`: catalog and Free/Pro rule tests
